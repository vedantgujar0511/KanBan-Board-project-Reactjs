...
const Kanban = () => {
  ...
  const sortColumnsByPriority = () => {
    const sortedColumns = [...columns].sort((a, b) => a.priorityID - b.priorityID);
    setColumns(sortedColumns);
    handleMenuClose();
  };

  const sortColumnsByTitle = () => {
    const sortedColumns = [...columns].sort((a, b) => a.name.localeCompare(b.name));
    setColumns(sortedColumns);
    handleMenuClose();
  };

  const sortColumnsByStatus = () => {
    const sortedColumns = [...columns].sort((a, b) => a.name.localeCompare(b.name));
    setColumns(sortedColumns);
    handleMenuClose();
  };
  ...
  return (
    <>
      ...
      >
        <MenuItem onClick={sortColumnsByPriority}>By Priority</MenuItem>
        <MenuItem onClick={sortColumnsByTitle}>By Title</MenuItem>
        <MenuItem onClick={sortColumnsByStatus}>By Status</MenuItem>
      </Menu>
        <Box>
          {modal && (
            <KanModal
